"use client";
export function SuggestionCards({label,options,value,onSelect,disabled=false}:{label:string;options:{label:string;text:string;hint?:string}[];value:string;onSelect:(v:string)=>void;disabled?:boolean}) {
